...
Nova.booting(function (Vue, router) {
    Vue.component('index-rut-field', __webpack_require__(4));
    Vue.component('detail-rut-field', __webpack_require__(7));
    Vue.component('form-rut-field', __webpack_require__(10));
});
...
var render = function() {
  ...
  return _c("span", [_vm._v(_vm._s(_vm.rutFormat(_vm.field.value)))])
}
var staticRenderFns = []
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.edited_field
    ? _c("panel-item", { attrs: { field: _vm.edited_field } })
    : _vm._e()
}
var staticRenderFns = []
render._withStripped = true
  ...
  methods: {
    ...
    fill: function fill(formData) {
      ...
      if (this.saveNormalized) {
        value = Object(__WEBPACK_IMPORTED_MODULE_1_rut_helpers__["rutClean"])(this.value);
      }
    ...
    changeKeyUp: function changeKeyUp() {
      if (this.eventListener !== 'keyup') return;
      this.change();
    },
    changeBlur: function changeBlur() {
